...
.. csv-table::
    ...
    parallaxoriginx,  double,           "X coordinate of the parallax origin in pixels (default: 0)"
    parallaxoriginy,  double,           "Y coordinate of the parallax origin in pixels (default: 0)"
