...
PyObject *
_wrap_PyTiledObject_className(PyTiledObject *self)
{
    PyObject *py_retval;
    QString retval;
...
static PyMethodDef PyTiledObject_methods[] = {
    ...
    {(char *) "setClassName", (PyCFunction) _wrap_PyTiledObject_setClassName, METH_VARARGS|METH_KEYWORDS, "setClassName(n)\n\ntype: n: QString" },
...
PyObject *
_wrap_PyTiledLayer_offset(PyTiledLayer *self)
{
    PyObject *py_retval;
...
static PyMethodDef PyTiledLayer_methods[] = {
    ...
    {(char *) "setOffset", (PyCFunction) _wrap_PyTiledLayer_setOffset, METH_VARARGS|METH_KEYWORDS, "setOffset(offset)\n\ntype: offset: QPointF" },
