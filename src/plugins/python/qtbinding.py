...
def generate(parent_mod):
  ...
  cls_qpointf.add_method('x', 'float', [])
  cls_qpointf.add_method('setX', None, [('float','x')])
  cls_qpointf.add_method('y', 'float', [])
  cls_qpointf.add_method('setY', None, [('float','y')])

  cls_sizef = mod.add_class('QSizeF')
  cls_sizef.add_copy_constructor()
  cls_sizef.add_constructor([('float','w'),('float','h')])
  cls_sizef.add_method('width', 'float', [])
  cls_sizef.add_method('setWidth', None, [('float','w')])
  cls_sizef.add_method('height', 'float', [])
  cls_sizef.add_method('setHeight', None, [('float','h')])
