...
cls_map.add_method('setRenderOrder', None, [('RenderOrder','ro')])
...
#cls_map.add_method('backgroundColor', 'const Qcolor', [])
#cls_map.add_method('setBackgroundColor', None, [('Qcolor', 'color')])
...
#cls_map.add_method('setStaggerIndex', None, [('StaggerAxis', 'staggerAxis')])
cls_map.add_method('invertStaggerIndex', None, [])
cls_map.add_method('setNextObjectId', None, [('int', 'nextId')])
