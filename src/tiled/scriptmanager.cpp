...
namespace Tiled
{
    ...
    {
        if (fileName.endsWith(QLatin1String(".js"), Qt::CaseInsensitive) || fileName.endsWith(QLatin1String(".qml"), Qt::CaseInsensitive))
        {
    ...
    void ScriptManager::throwNullArgError(int argNumber)
    {
        throwError(QCoreApplication::translate("Script Errors",
                                               "Argument %1 is undefined or the wrong type")
                       .arg(argNumber));
    }
