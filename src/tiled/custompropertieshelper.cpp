...
QtVariantProperty *CustomPropertiesHelper::createCustomProperty(const QString &name,
                                                                const QVariant &value)
{
    Q_ASSERT(!mProperties.contains(name));

    QtVariantProperty *property = createProperty(name, value);
...
void CustomPropertiesHelper::deleteProperty(QtProperty *property)
{
    ...
    // not the case for component properties
