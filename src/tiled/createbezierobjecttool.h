...
#ifndef CREATEBEZIEROBJECTTOOL_H
#define CREATEBEZIEROBJECTTOOL_H
...
class CreateBezierObjectTool : public CreateObjectTool
{
    Q_OBJECT
public:
    CreateBezierObjectTool(QObject *parent);
...
private:
    bool mMouseIsDown;
    ControlPointsHandle* mPreviousControlPointsHandle;
    ControlPointsHandle* mCurrentControlPointsHandle;
};

}
}

#endif // CREATEBEZIEROBJECTTOOL_H
